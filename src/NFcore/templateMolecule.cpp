...
bool TemplateMolecule::checkSymmetry(TemplateMolecule *tm1, TemplateMolecule *tm2, string bSite1, string bSite2)
{
	...
	// NOTE: This symmetry check is currently a heuristic based on local structure comparison.
	// A complete graph isomorphism check for all possible symmetric cases is computationally
	// expensive and requires full recursive evaluation between the two templates.
	// The current logic safely handles common structural symmetries without the overhead
	// of a generalized graph comparison.
